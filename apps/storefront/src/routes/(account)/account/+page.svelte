...
<section class="mt-6 rounded-xl border border-neutral-200 bg-white p-6">
	<div class="flex items-center justify-between">
		<h2 class="font-heading text-lg font-semibold text-neutral-900">Recent Orders</h2>
		<a href="/account/orders" class="text-sm font-medium text-neutral-600 hover:text-neutral-900">
			View all &rarr;
		</a>
	</div>
	<div class="mt-4 flex items-center gap-3 text-neutral-400">
		<Package class="h-8 w-8" />
		<p class="text-sm">View and track your orders in the <a href="/account/orders" class="underline hover:text-neutral-600">Orders</a> section.</p>
	</div>
</section>
